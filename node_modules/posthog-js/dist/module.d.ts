...
declare class RateLimiter {
    ...
    checkForLimiting: (httpResponse: MinimalHTTPResponse) => void;
}
...
interface RequestData extends QueuedRequestData {
...
type FeatureFlagsCallback = (flags: string[], variants: Record<string, string | boolean>) => void;
...
type RequestCallback = (response: Record<string, any>, data?: Properties) => void;
