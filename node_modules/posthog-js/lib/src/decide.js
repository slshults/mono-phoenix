...
var Decide = /** @class */ (function () {
    ...
    Decide.prototype.call = function () {
        ...
        */
        ...
        this.instance._send_request(this.instance.requestRouter.endpointFor('api', '/decide/?v=3'), { data: encoded_data, verbose: true }, { method: 'POST' }, function (response) { return _this.parseDecideResponse(response); });
    };
