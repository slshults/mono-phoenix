...
function redactPayload(payload, headers, limit, description) {
    ...
    if (requestContentLength > limit) {
        return "[SessionReplay] ".concat(description, " body too large to record (").concat(requestContentLength, " bytes)");
    }
    return payload;
}
