...
var removeAuthorizationHeader = function (data) {
    var _a;
    _each(Object.keys((_a = data.requestHeaders) !== null && _a !== void 0 ? _a : {}), function (header) {
        var _a;
...
function scrubPayload(payload, label) {
    ...
    _each(PAYLOAD_CONTENT_DENY_LIST, function (text) {
...
export var buildNetworkRequestOptions = function (instanceConfig, remoteNetworkOptions) {
    ...
    var enforcedCleaningFn = function (d) {
        return scrubPayloads(payloadLimiter(ignorePostHogPaths(removeAuthorizationHeader(d))));
    };
