...
var encodePostData = function (_a) {
    var data = _a.data, compression = _a.compression, transport = _a.transport, method = _a.method;
    if (!data) {
        return null;
    }
    ...
    if (transport === 'sendBeacon') {
        var body = compression === Compression.Base64 ? _base64Encode(JSON.stringify(data)) : data;
...
var xhr = function (options) {
    ...
    var body = encodePostData(options);
