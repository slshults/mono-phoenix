...
var PostHogSurveys = /** @class */ (function () {
    ...
    PostHogSurveys.prototype.getSurveys = function (callback, forceReload) {
        ...
        if (!existingSurveys || forceReload) {
            this.instance._send_request(this.instance.requestRouter.endpointFor('api', "/api/surveys/?token=".concat(this.instance.config.token)), {}, { method: 'GET' }, function (response) {
                var _a;
                var _b;
