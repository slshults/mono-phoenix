...
var PostHogFeatureFlags = /** @class */ (function () {
    ...
    PostHogFeatureFlags.prototype.getEarlyAccessFeatures = function (callback, force_reload) {
        ...
        if (!existing_early_access_features || force_reload) {
            this.instance._send_request(this.instance.requestRouter.endpointFor('api', "/api/early_access_features/?token=".concat(this.instance.config.token)), {}, { method: 'GET' }, function (response) {
                var _a;
                var _b;
