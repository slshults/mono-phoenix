...
config :mono_phoenix_v01, MonoPhoenixV01Web.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "wsHNA4GMB1xXQ1WsN13hus8pqQAcjUn844uDiYJ/vxdFtLEWLTNZSzlUkLaB0dLn",
  watchers: [
...
config :mono_phoenix_v01, MonoPhoenixV01Web.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/mono_phoenix_v01_web/(live|views)/.*(ex)$",
      ~r"lib/mono_phoenix_v01_web/templates/.*(eex)$"
    ]
  ]
