defmodule MonoPhoenixV01Web.WomensPageController do
  use MonoPhoenixV01Web, :controller
  import Ecto.Query, only: [from: 2]

  # Show lists of the plays
  @spec womens(Plug.Conn.t(), any) :: Plug.Conn.t()
  def womens(conn, _params) do
    ...
    render(conn, "womens.html", rows: rows)
  end
end
...
#       @moduledoc """
#       Controller for womens
#       """
#
#       # Gets the index page for womens
...
#         session[:play] = nil
#         render(conn, "womens/index", title: title, plays: # plays, comedies: comedies, histories: histories, # tragedies: tragedies, scope: scope)
#       end
#
#       # Gets the index page for womens
#       get "/womens", play_index: true, cache: true
