...
`);
  ...
  document.addEventListener("DOMContentLoaded", function() {
    document.addEventListener("click", function(event) {
      if (event.target.closest('a[href*="ko-fi.com"]') || event.target.closest("#kofi-toggle-btn") || event.target.closest("#kofi-left-toggle-btn") || event.target.closest("#kofi-footer-toggle-btn")) {
