...
`);
  ...
  Hooks2.PasswordToggle = {
    ...
    updated() {
      if (this.input && this.shown !== void 0) {
        this.applyState();
      }
    },
    applyState() {
      ...
      if (this.openIcon)
        this.openIcon.style.display = this.shown ? "none" : "inline-flex";
      if (this.shutIcon)
        this.shutIcon.style.display = this.shown ? "inline-flex" : "none";
      if (this.button) {
  ...
  function verifyPostHogIdentity() {
    ...
    if (typeof posthog.get_distinct_id !== "function")
      return;
    if (typeof posthog.setIdentity !== "function")
      return;
    var distinctId;
    try {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (dismissedAt && Date.now() - parseInt(dismissedAt) < 3 * 24 * 60 * 60 * 1e3)
      return;
    function showAdblockModal() {
      overlay.style.display = "flex";
      if (typeof posthog !== "undefined")
        posthog.capture("adblock_modal_shown");
    }
    setTimeout(function() {
    ...
    document.getElementById("adblock-dismiss").addEventListener("click", function() {
      if (typeof posthog !== "undefined")
        posthog.capture("adblock_modal_dismissed");
    ...
    if (adblockKofiLink) {
      adblockKofiLink.addEventListener("click", function() {
        if (typeof posthog !== "undefined")
          posthog.capture("clicked_tipjar", { source: "adblock_modal" });
      });
    }
