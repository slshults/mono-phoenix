...
`);
  ...
  document.addEventListener("click", function(event) {
    if (event.target.matches(".summary-icon") || event.target.closest(".summary-icon")) {
      ...
      if (!monologue_id && play_title && !location2) {
        event_name = "play_summary_requested";
        properties.play_title = play_title;
      } else if (location2 || monologueRow && monologueRow.querySelector(".monologue-actscene")) {
        event_name = "scene_summary_requested";
        properties.play_title = play_title;
        properties.location = location2 || (monologueRow.querySelector(".monologue-actscene") ? monologueRow.querySelector(".monologue-actscene").textContent.trim() : null);
      } else {
